...
public class StoreItemExistsException extends ExpiringStoreException {
     ...
     */
    public StoreItemExistsException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public StoreItemExistsException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public StoreItemExistsException(Throwable cause) {
        super(cause);
    }
}
