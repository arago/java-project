...
public class StoreItemExpiredException extends ExpiringStoreException {
     ...
     */
    public StoreItemExpiredException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public StoreItemExpiredException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public StoreItemExpiredException(Throwable cause) {
        super(cause);
    }
}
